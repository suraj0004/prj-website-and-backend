    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                ...
                <div class="ts-service-box d-flex">
                    <div class="ts-service-box-img">
                        <img loading="lazy" src={{ asset('images/icon-image/service-icon2.png') }} alt="service-icon">
                    </div>
                    <div class="ts-service-box-info">
                ...
                <div class="ts-service-box d-flex">
                    <div class="ts-service-box-img">
                        <img loading="lazy" src={{ asset('images/icon-image/service-icon3.png') }} alt="service-icon">
                    </div>
                    <div class="ts-service-box-info">
            ...
            <div class="col-lg-4 mt-5 mt-lg-0 mb-4 mb-lg-0">
                <div class="ts-service-box d-flex">
                    <div class="ts-service-box-img">
                        <img loading="lazy" src={{ asset('images/icon-image/service-icon4.png') }} alt="service-icon">
                    </div>
                    <div class="ts-service-box-info">
                ...
                <div class="ts-service-box d-flex">
                    <div class="ts-service-box-img">
                        <img loading="lazy" src={{ asset('images/icon-image/service-icon5.png') }} alt="service-icon">
                    </div>
                    <div class="ts-service-box-info">
                ...
                <div class="ts-service-box d-flex">
                    <div class="ts-service-box-img">
                        <img loading="lazy" src={{ asset('images/icon-image/service-icon6.png') }} alt="service-icon">
                    </div>
                    <div class="ts-service-box-info">
